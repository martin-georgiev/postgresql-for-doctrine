...
final class Int4Range extends BaseIntegerRange
{
    ...
    public function __construct(
        ...
        if ($lower !== null && ($lower < self::MIN_INT4_VALUE || $lower > self::MAX_INT4_VALUE)) {
            throw InvalidRangeException::forBoundOutsideSubtypeRange($lower, self::MIN_INT4_VALUE, self::MAX_INT4_VALUE);
        }

        if ($upper !== null && ($upper < self::MIN_INT4_VALUE || $upper > self::MAX_INT4_VALUE)) {
            throw InvalidRangeException::forBoundOutsideSubtypeRange($upper, self::MIN_INT4_VALUE, self::MAX_INT4_VALUE);
        }
