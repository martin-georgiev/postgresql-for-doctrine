 ...
 */
class InvalidBoxArrayItemForPHPException extends ConversionException
{
    ...
    {
        return self::create('Cannot convert box array item to PHP value. Expected a string or null, got %s.', $value);
    }
