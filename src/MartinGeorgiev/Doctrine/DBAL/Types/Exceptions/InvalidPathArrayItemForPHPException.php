 ...
 */
class InvalidPathArrayItemForPHPException extends ConversionException
{
    ...
    {
        return self::create('Cannot convert path array item to PHP value. Expected a string or null, got %s.', $value);
    }
