 ...
 */
class InvalidCircleArrayItemForPHPException extends ConversionException
{
    ...
    {
        return self::create('Cannot convert circle array item to PHP value. Expected a string or null, got %s.', $value);
    }
