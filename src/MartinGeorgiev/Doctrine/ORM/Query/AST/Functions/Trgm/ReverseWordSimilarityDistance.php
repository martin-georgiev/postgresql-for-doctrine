 ...
 * that is one minus the word_similarity() value, with operands reversed.
 *
 ...
 *
 * @example Using it in DQL: "SELECT REVERSE_WORD_SIMILARITY_DISTANCE(:search, e.name) FROM Entity e"
 */
class ReverseWordSimilarityDistance extends BaseFunction
{
