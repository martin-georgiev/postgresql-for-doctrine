...
final class AsciiTest extends TextTestCase
{
    ...
    #[Test]
    public function returns_the_ascii_code_from_a_text_literal(): void
    {
    ...
    #[Test]
    public function returns_the_ascii_code_from_an_entity_field(): void
    {
