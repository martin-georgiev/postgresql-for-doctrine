...
final class ST_GeometryTypeTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_geometry_type_of_a_wkt_literal(): void
    {
        $dql = "SELECT ST_GEOMETRYTYPE(ST_GEOMFROMTEXT('POINT(1 2)')) as result
    ...
    #[Test]
    public function returns_the_geometry_type_of_an_entity_field(): void
    {
