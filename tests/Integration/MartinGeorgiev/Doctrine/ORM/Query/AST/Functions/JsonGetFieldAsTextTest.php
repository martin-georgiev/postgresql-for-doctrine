...
final class JsonGetFieldAsTextTest extends JsonTestCase
{
    ...
    #[Test]
    public function returns_the_text_field_by_property_name_from_an_entity_field(): void
    {
    ...
    #[Test]
    public function returns_the_text_field_by_index_from_an_entity_field(): void
    {
