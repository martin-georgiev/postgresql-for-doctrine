...
final class ST_ClosestPointTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_closest_point_from_a_literal_operand(): void
    {
        $dql = "SELECT ST_GEOMETRYTYPE(ST_CLOSESTPOINT(g.geometry1, 'SRID=4326;POINT(1 1)')) as result
                FROM Fixtures\MartinGeorgiev\Doctrine\Entity\ContainsGeometries g
                WHERE g.id = 1";
