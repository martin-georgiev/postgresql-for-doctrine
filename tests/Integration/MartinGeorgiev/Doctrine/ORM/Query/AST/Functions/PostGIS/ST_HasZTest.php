...
final class ST_HasZTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_whether_a_wkt_literal_has_z(): void
    {
        $dql = "SELECT ST_HASZ(ST_GEOMFROMTEXT('POINT Z(0 0 5)')) as result
    ...
    #[Test]
    public function returns_whether_an_entity_field_has_z(): void
    {
