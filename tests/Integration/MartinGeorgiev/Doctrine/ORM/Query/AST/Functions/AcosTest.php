...
final class AcosTest extends NumericTestCase
{
    ...
    #[Test]
    public function returns_the_arc_cosine_from_a_numeric_literal(): void
    {
    ...
    #[Test]
    public function returns_the_arc_cosine_from_an_entity_field(): void
    {
