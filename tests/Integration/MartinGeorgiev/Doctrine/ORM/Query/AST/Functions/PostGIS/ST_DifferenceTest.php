...
final class ST_DifferenceTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_difference_between_wkt_literals(): void
    {
        $dql = "SELECT ST_AREA(ST_DIFFERENCE(ST_GEOMFROMTEXT('POLYGON((0 0,0 4,4 4,4 0,0 0))'), ST_GEOMFROMTEXT('POLYGON((1 1,1 3,3 3,3 1,1 1))'))) as result
    ...
    #[Test]
    public function returns_the_difference_between_entity_fields(): void
    {
