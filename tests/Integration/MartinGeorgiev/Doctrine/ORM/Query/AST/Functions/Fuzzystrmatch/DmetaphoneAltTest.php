...
final class DmetaphoneAltTest extends TestCase
{
    ...
    #[Test]
    public function computes_alternate_double_metaphone_code(): void
    {
    ...
    #[Test]
    public function computes_dmetaphone_alt_from_text_field(): void
    {
