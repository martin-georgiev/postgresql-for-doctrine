...
final class SkeysTest extends TestCase
{
    ...
    #[Test]
    public function returns_the_keys_as_a_set_from_an_hstore_literal(): void
    {
    ...
    #[Test]
    public function returns_the_keys_as_a_set_from_an_entity_field(): void
    {
