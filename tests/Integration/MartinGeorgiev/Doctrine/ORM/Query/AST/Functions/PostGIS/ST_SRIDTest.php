...
final class ST_SRIDTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_srid_of_a_wkt_literal(): void
    {
        $dql = "SELECT ST_SRID(ST_GEOMFROMTEXT('POINT(1 2)', 4326)) as result
    ...
    #[Test]
    public function returns_the_srid_of_an_entity_field(): void
    {
