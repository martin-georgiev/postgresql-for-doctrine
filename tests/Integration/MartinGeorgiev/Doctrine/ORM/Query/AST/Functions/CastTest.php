...
class CastTest extends TestCase
{
    ...
    #[Test]
    public function cast_text_to_integer(): void
    {
    ...
    #[Test]
    public function cast_text_to_text(): void
    {
    ...
    #[Test]
    public function cast_text_to_boolean(): void
    {
    ...
    #[Test]
    public function cast_text_to_decimal(): void
    {
    ...
    #[Test]
    public function cast_array_to_text_array(): void
    {
    ...
    #[Test]
    public function cast_boolean_array_to_integer_array(): void
    {
    ...
    #[Test]
    public function cast_with_where_condition(): void
    {
    ...
    #[Test]
    public function cast_in_complex_query(): void
    {
    ...
    #[Test]
    public function cast_numeric_to_integer(): void
    {
    ...
    #[Test]
    public function cast_numeric_to_decimal(): void
    {
    ...
    #[Test]
    public function cast_throws_with_invalid_type(): void
    {
    ...
    #[Test]
    public function cast_throws_with_null_input(): void
    {
    ...
    #[Test]
    public function cast_lowercase_array_types(): void
    {
    ...
    #[Test]
    public function cast_mixed_case_array_types(): void
    {
        $dql = 'SELECT CAST(a.integerArray AS Text[]) AS result FROM Fixtures\\MartinGeorgiev\\Doctrine\\Entity\\ContainsArrays a WHERE a.id = 1';
        $result = $this->executeDqlQuery($dql);
        static::assertIsString($result[0]['result']);
    ...
    #[Test]
    public function cast_parameterized_decimal_array(): void
    {
