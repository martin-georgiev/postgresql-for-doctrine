...
final class ST_HasMTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_whether_a_wkt_literal_has_m(): void
    {
        $dql = "SELECT ST_HASM(ST_GEOMFROMTEXT('POINT M(0 0 5)')) as result
    ...
    #[Test]
    public function returns_whether_an_entity_field_has_m(): void
    {
