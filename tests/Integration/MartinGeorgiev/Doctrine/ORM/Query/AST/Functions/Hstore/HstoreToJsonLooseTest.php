...
final class HstoreToJsonLooseTest extends TestCase
{
    ...
    #[Test]
    public function converts_the_hstore_to_json_from_an_hstore_literal(): void
    {
    ...
    #[Test]
    public function converts_the_hstore_to_json_from_an_entity_field(): void
    {
