...
final class ST_IsEmptyTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_whether_a_wkt_literal_is_empty(): void
    {
        $dql = "SELECT ST_ISEMPTY(ST_GEOMFROMTEXT('GEOMETRYCOLLECTION EMPTY')) as result
    ...
    #[Test]
    public function returns_whether_an_entity_field_is_empty(): void
    {
