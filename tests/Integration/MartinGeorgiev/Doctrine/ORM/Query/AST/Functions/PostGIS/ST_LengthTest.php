...
final class ST_LengthTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_length_of_a_wkt_literal(): void
    {
        $dql = "SELECT ST_LENGTH(ST_GEOMFROMTEXT('LINESTRING(0 0,3 4)')) as result
    ...
    #[Test]
    public function returns_the_length_of_an_entity_field(): void
    {
    ...
    public function respects_the_use_spheroid_flag(): void
    {
        ...
        $result = $this->executeDqlQuery($dql);
        $this->assertEqualsWithDelta(1410.1406247192313, $result[0]['result'], 0.0000001);
    }
}
