...
class JsonTypeofTest extends JsonTestCase
{
    ...
    {
        $dql = "SELECT JSON_TYPEOF(t.jsonObject1->'tags') as result 
                FROM Fixtures\\MartinGeorgiev\\Doctrine\\Entity\\ContainsJsons t 
                WHERE t.id = 1";
        $result = $this->executeDqlQuery($dql);
    ...
    {
        $dql = "SELECT JSON_TYPEOF(t.jsonObject1->'name') as result 
                FROM Fixtures\\MartinGeorgiev\\Doctrine\\Entity\\ContainsJsons t 
                WHERE t.id = 1";
        $result = $this->executeDqlQuery($dql);
    ...
    {
        $dql = "SELECT JSON_TYPEOF(t.jsonObject1->'age') as result 
                FROM Fixtures\\MartinGeorgiev\\Doctrine\\Entity\\ContainsJsons t 
                WHERE t.id = 1";
        $result = $this->executeDqlQuery($dql);
