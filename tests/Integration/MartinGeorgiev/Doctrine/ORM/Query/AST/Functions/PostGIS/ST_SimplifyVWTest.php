...
final class ST_SimplifyVWTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_visvalingam_simplified_form_of_a_wkt_literal(): void
    {
        $dql = "SELECT ST_LENGTH(ST_SIMPLIFYVW(ST_GEOMFROMTEXT('LINESTRING(0 0,1 1,2 2)'), 0.1)) as result
    ...
    #[Test]
    public function returns_the_visvalingam_simplified_form_of_an_entity_field(): void
    {
        $dql = 'SELECT ST_LENGTH(ST_SIMPLIFYVW(g.geometry1, 0.1)) as result
                FROM Fixtures\MartinGeorgiev\Doctrine\Entity\ContainsGeometries g
                WHERE g.id = 3';
