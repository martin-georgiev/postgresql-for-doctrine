...
final class ST_Length2DTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_2d_length_of_a_wkt_literal(): void
    {
        $dql = "SELECT ST_LENGTH2D(ST_GEOMFROMTEXT('LINESTRING(0 0,3 4)')) as result
    ...
    #[Test]
    public function returns_the_2d_length_of_an_entity_field(): void
    {
