...
class JsonbEachTest extends JsonTestCase
{
    ...
    public function test_jsonb_each_with_different_object(): void
    {
        $dql = 'SELECT JSONB_EACH(t.object1) as result 
                FROM Fixtures\MartinGeorgiev\Doctrine\Entity\ContainsJsons t 
                WHERE t.id = 2';
    ...
    public function test_jsonb_each_with_nulls(): void
    {
        $dql = 'SELECT JSONB_EACH(t.object1) as result 
                FROM Fixtures\MartinGeorgiev\Doctrine\Entity\ContainsJsons t 
                WHERE t.id = 5';
    ...
    public function test_jsonb_each_with_empty_tags_array(): void
    {
        $dql = 'SELECT JSONB_EACH(t.object1) as result 
                FROM Fixtures\MartinGeorgiev\Doctrine\Entity\ContainsJsons t 
                WHERE t.id = 3';
