...
final class ST_HausdorffDistanceTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_hausdorff_distance_from_entity_fields(): void
    {
    ...
    #[Test]
    public function returns_the_hausdorff_distance_from_a_literal_operand(): void
    {
        $dql = "SELECT ST_HAUSDORFFDISTANCE(g.geometry1, 'SRID=4326;POINT(1 1)') as result
                FROM Fixtures\MartinGeorgiev\Doctrine\Entity\ContainsGeometries g
                WHERE g.id = 1";
