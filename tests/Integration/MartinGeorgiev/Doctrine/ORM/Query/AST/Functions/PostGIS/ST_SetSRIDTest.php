...
final class ST_SetSRIDTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_srid_set_on_a_wkt_literal(): void
    {
        $dql = "SELECT ST_SRID(ST_SETSRID(ST_GEOMFROMTEXT('POINT(1 2)'), 3857)) as result
    ...
    #[Test]
    public function returns_the_srid_set_on_an_entity_field(): void
    {
