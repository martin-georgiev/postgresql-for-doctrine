...
final class AtandTest extends NumericTestCase
{
    ...
    #[Test]
    public function returns_the_arc_tangent_in_degrees_from_a_numeric_literal(): void
    {
    ...
    #[Test]
    public function returns_the_arc_tangent_in_degrees_from_an_entity_field(): void
    {
