...
final class ArrayToStringTest extends ArrayTestCase
{
    ...
    #[Test]
    public function converts_the_array_to_a_delimited_string_from_an_array_literal(): void
    {
    ...
    #[Test]
    public function converts_the_array_to_a_delimited_string_from_an_entity_field(): void
    {
