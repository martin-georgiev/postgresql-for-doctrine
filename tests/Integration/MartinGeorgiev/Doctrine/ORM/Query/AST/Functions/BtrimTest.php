...
final class BtrimTest extends TextTestCase
{
    ...
    #[Test]
    public function returns_the_trimmed_text_from_a_text_literal(): void
    {
    ...
    #[Test]
    public function returns_the_trimmed_text_from_an_entity_field(): void
    {
