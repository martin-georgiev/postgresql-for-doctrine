...
final class ST_DisjointTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_whether_the_geometries_are_disjoint_from_a_literal_operand(): void
    {
        $dql = "SELECT ST_DISJOINT(g.geometry1, 'SRID=4326;POINT(1 1)') as result
                FROM Fixtures\MartinGeorgiev\Doctrine\Entity\ContainsGeometries g
                WHERE g.id = 1";
