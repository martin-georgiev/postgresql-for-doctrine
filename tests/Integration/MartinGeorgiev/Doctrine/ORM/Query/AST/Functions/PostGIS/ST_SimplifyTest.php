...
final class ST_SimplifyTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_simplified_form_of_a_wkt_literal(): void
    {
        $dql = "SELECT ST_LENGTH(ST_SIMPLIFY(ST_GEOMFROMTEXT('LINESTRING(0 0,1 1,2 2)'), 0.1)) as result
    ...
    #[Test]
    public function returns_the_simplified_form_of_an_entity_field(): void
    {
