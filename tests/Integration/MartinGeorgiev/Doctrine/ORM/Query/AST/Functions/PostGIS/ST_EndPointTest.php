...
final class ST_EndPointTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_last_vertex_from_a_wkt_literal(): void
    {
        $dql = "SELECT ST_ASTEXT(ST_ENDPOINT(ST_GEOMFROMTEXT('LINESTRING(0 0,1 1,2 2)'))) as result
    ...
    #[Test]
    public function returns_the_last_vertex_from_an_entity_field(): void
    {
