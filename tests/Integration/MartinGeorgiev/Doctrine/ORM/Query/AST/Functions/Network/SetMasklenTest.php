...
final class SetMasklenTest extends TestCase
{
    ...
    #[Test]
    public function returns_the_address_with_the_given_mask_length_from_a_literal(): void
    {
    ...
    #[Test]
    public function returns_the_address_with_the_given_mask_length_from_an_entity_field(): void
    {
