...
final class ST_PointOnSurfaceTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_a_point_on_the_surface_of_a_wkt_literal(): void
    {
        $dql = "SELECT ST_CONTAINS(ST_GEOMFROMTEXT('POLYGON((0 0,0 4,4 4,4 0,0 0))'), ST_POINTONSURFACE(ST_GEOMFROMTEXT('POLYGON((0 0,0 4,4 4,4 0,0 0))'))) as result
    ...
    #[Test]
    public function returns_a_point_on_the_surface_of_an_entity_field(): void
    {
