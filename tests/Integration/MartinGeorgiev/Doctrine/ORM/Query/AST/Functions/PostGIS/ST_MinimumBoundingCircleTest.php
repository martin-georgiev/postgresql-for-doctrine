...
final class ST_MinimumBoundingCircleTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_minimum_bounding_circle_from_an_entity_field(): void
    {
    ...
    #[Test]
    public function returns_the_minimum_bounding_circle_from_a_wkt_literal(): void
    {
        $dql = "SELECT ST_AREA(ST_MINIMUMBOUNDINGCIRCLE('POLYGON((0 0, 0 4, 4 4, 4 0, 0 0))')) as result
                FROM Fixtures\MartinGeorgiev\Doctrine\Entity\ContainsGeometries g
                WHERE g.id = 2";
