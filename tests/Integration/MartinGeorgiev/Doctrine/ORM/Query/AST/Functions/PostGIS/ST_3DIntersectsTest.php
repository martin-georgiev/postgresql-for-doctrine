...
final class ST_3DIntersectsTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_whether_wkt_literals_intersect_in_3d(): void
    {
        $dql = "SELECT ST_3DINTERSECTS(ST_GEOMFROMTEXT('POINT Z(0 0 5)'), ST_GEOMFROMTEXT('POINT Z(0 0 5)')) as result
    ...
    #[Test]
    public function returns_whether_entity_fields_intersect_in_3d(): void
    {
