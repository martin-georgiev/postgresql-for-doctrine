...
final class ST_3DIntersectsTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_whether_the_geometries_intersect_in_3d_from_a_literal_operand(): void
    {
        $dql = "SELECT ST_3DINTERSECTS(g.geometry1, 'SRID=4326;POINT(1 1)') as result
                FROM Fixtures\MartinGeorgiev\Doctrine\Entity\ContainsGeometries g
                WHERE g.id = 1";
