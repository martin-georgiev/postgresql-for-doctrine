...
final class MakeTimestamptzTest extends DateMakingTestCase
{
    ...
    #[Test]
    public function creates_a_timestamptz_from_literals(): void
    {
    ...
    #[Test]
    public function creates_a_timestamptz_from_entity_fields(): void
    {
