...
final class JsonbBuildArrayTest extends JsonTestCase
{
    ...
    #[Test]
    public function creates_a_jsonb_array_from_text_literals(): void
    {
    ...
    #[Test]
    public function creates_a_jsonb_array_from_entity_fields(): void
    {
