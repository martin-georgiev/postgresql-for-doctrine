...
final class XmlIsWellFormedDocumentTest extends TextTestCase
{
    ...
    #[Test]
    public function returns_whether_the_document_is_well_formed_from_a_literal(): void
    {
    ...
    #[Test]
    public function returns_whether_the_document_is_well_formed_from_an_entity_field(): void
    {
