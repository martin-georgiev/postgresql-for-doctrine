...
final class ST_UnaryUnionTest extends SpatialOperatorTestCase
{
    ...
    #[Test]
    public function returns_the_unary_union_of_a_wkt_literal(): void
    {
        $dql = "SELECT ST_AREA(ST_UNARYUNION(ST_GEOMFROMTEXT('POLYGON((0 0,0 4,4 4,4 0,0 0))'))) as result
    ...
    #[Test]
    public function returns_the_unary_union_of_an_entity_field(): void
    {
