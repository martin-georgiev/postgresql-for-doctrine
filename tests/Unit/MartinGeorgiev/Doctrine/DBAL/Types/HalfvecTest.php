...
final class HalfvecTest extends TestCase
{
    /**
    ...
    private Halfvec $fixture;

    protected function setUp(): void
    {
        $this->platform = $this->createMock(AbstractPlatform::class);
        $this->fixture = new Halfvec();
    }

    #[Test]
    public function has_name(): void
    {
        $this->assertSame('halfvec', $this->fixture->getName());
    }
    ...
    {
        $this->expectException(InvalidHalfvecForPHPException::class);
    ...
    #[Test]
    public function throws_exception_for_invalid_halfvec_format(): void
    {
        $this->expectException(InvalidHalfvecForPHPException::class);
