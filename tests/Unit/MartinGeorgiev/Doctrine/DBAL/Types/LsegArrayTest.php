...
final class LsegArrayTest extends TestCase
{
    /**
    ...
    #[Test]
    public function can_convert_to_database_value(?array $phpValue, ?string $postgresValue): void
    {
    ...
    #[Test]
    public function can_convert_null_item_for_php(): void
    {
