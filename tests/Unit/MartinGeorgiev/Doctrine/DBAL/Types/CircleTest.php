...
final class CircleTest extends TestCase
{
    ...
    #[Test]
    public function converts_to_database_value(CircleValueObject $circleValueObject, string $postgresValue): void
    {
    ...
    #[DataProvider('provideValidTransformations')]
    #[Test]
    public function converts_to_php_value(CircleValueObject $circleValueObject, string $postgresValue): void
    {
