...
final class TstzMultirangeTest extends TestCase
{
    #[Test]
    ...
    public static function provideValidFromStringCases(): array
    {
        return [
            ...
            'non-UTC offset' => [
                '{[2024-01-01 09:00:00+02:00,2024-01-01 17:00:00+02:00)}',
                '{[2024-01-01 09:00:00.000000+02:00,2024-01-01 17:00:00.000000+02:00)}',
            ],
        ];
    }
