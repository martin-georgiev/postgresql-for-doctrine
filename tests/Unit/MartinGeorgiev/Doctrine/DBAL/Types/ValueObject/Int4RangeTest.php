...
final class Int4RangeTest extends BaseRangeTestCase
{
    ...
    public static function provideContainsTestCases(): \Generator
    {
        ...
        yield 'empty range excludes any value' => [Int4Range::empty(), 5, false];

        $unboundedLower = new Int4Range(null, 10);
        ...
        $unboundedUpper = new Int4Range(1, null);
    ...
    {
        $this->expectException(InvalidRangeException::class);
        $this->expectExceptionMessage('Range bound must be within [-2147483648, 2147483647], -2147483649 given');
    ...
    {
        $this->expectException(InvalidRangeException::class);
        $this->expectExceptionMessage('Range bound must be within [-2147483648, 2147483647], 2147483648 given');
