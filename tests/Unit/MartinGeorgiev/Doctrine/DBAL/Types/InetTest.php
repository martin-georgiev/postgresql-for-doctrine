...
final class InetTest extends TestCase
{
    ...
    {
        $this->assertSame('inet', $this->fixture->getName());
    }

    #[DataProvider('provideValidTransformations')]
    #[Test]
    public function converts_to_database_value(?string $phpValue, ?string $postgresValue): void
    {
    ...
    #[DataProvider('provideValidTransformations')]
    #[Test]
    public function converts_to_php_value(?string $phpValue, ?string $postgresValue): void
    {
