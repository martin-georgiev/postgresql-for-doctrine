...
final class TstzRangeArrayTest extends TestCase
{
    ...
    private TstzRangeArray $fixture;

    protected function setUp(): void
    {
        $this->platform = $this->createStub(AbstractPlatform::class);
        $this->fixture = new TstzRangeArray();
    }

    #[Test]
    public function has_name(): void
    {
        $this->assertSame('tstzrange[]', $this->fixture->getName());
    }
     ...
     *     phpValue: array<TstzRangeValueObject|null>|null,
     *     postgresValue: string|null
     * }>
     */
    public static function provideValidTransformations(): array
    {
        $lower = new \DateTimeImmutable('2023-01-01 00:00:00.000000+00:00');
        $upper = new \DateTimeImmutable('2023-12-31 23:59:59.000000+00:00');
        ...
        return [
            ...
            'single range' => [
                'phpValue' => [new TstzRangeValueObject($lower, $upper)],
                'postgresValue' => '{"[2023-01-01 00:00:00.000000+00:00,2023-12-31 23:59:59.000000+00:00)"}',
            ],
            'multiple ranges' => [
                'phpValue' => [
                    new TstzRangeValueObject($lower, $upper),
                    new TstzRangeValueObject($upper, null),
                ],
                'postgresValue' => '{"[2023-01-01 00:00:00.000000+00:00,2023-12-31 23:59:59.000000+00:00)","[2023-12-31 23:59:59.000000+00:00,)"}',
            ],
            'array with null item' => [
                'phpValue' => [new TstzRangeValueObject($lower, $upper), null],
                'postgresValue' => '{"[2023-01-01 00:00:00.000000+00:00,2023-12-31 23:59:59.000000+00:00)",NULL}',
            ],
        ];
    }
    ...
    {
        $this->expectException(InvalidTstzRangeArrayItemForDatabaseException::class);
        $this->fixture->convertToDatabaseValue($phpValue, $this->platform); // @phpstan-ignore-line
    }
    ...
    {
        return [
            'array containing strings' => [['[2023-01-01+00:00,2023-12-31+00:00)']],
    ...
    public static function provideValidArrayItemsForDatabase(): array
    {
        return [
            'null value' => [null],
            'valid range object' => [new TstzRangeValueObject(
    ...
    {
        return [
            'string' => ['[2023-01-01 00:00:00+00:00,2023-12-31 23:59:59+00:00)'],
            'integer' => [42],
            'boolean' => [true],
            'object' => [new \stdClass()],
        ];
    ...
    {
        return self::malformedLiteralsAround('"[2023-01-01 00:00:00.000000+00:00,2023-12-31 23:59:59.000000+00:00)"', '"[2024-01-01 00:00:00.000000+00:00,2024-12-31 23:59:59.000000+00:00)"');
    }
}
