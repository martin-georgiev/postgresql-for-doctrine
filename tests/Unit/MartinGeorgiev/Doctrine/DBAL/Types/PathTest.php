...
final class PathTest extends TestCase
{
    ...
    #[Test]
    public function converts_to_database_value(PathValueObject $pathValueObject, string $postgresValue): void
    {
    ...
    #[DataProvider('provideValidTransformations')]
    #[Test]
    public function converts_to_php_value(PathValueObject $pathValueObject, string $postgresValue): void
    {
