...
final class TsRankCdTest extends BaseVariadicFunctionTestCase
{
    protected function createFixture(): TsRankCd
    {
    ...
    protected function getExpectedSqlStatements(): array
    {
        return [
            ...
            'ranks with weights' => 'SELECT ts_rank_cd(c0_.text1, c0_.text2, c0_.text1) AS sclr_0 FROM ContainsTexts c0_',
    ...
    protected function getDqlStatements(): array
    {
        return [
            ...
            'ranks with weights' => \sprintf('SELECT TS_RANK_CD(e.text1, e.text2, e.text1) FROM %s e', ContainsTexts::class),
