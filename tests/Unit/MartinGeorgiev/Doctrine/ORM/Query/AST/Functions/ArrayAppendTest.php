...
final class ArrayAppendTest extends TestCase
{
    ...
    protected function getExpectedSqlStatements(): array
    {
        return [
            ...
            'appends numeric element to array' => 'SELECT array_append(c0_.integerArray, 42) AS sclr_0 FROM ContainsArrays c0_',
    ...
    protected function getDqlStatements(): array
    {
        return [
            ...
            'appends numeric element to array' => \sprintf('SELECT ARRAY_APPEND(e.integerArray, 42) FROM %s e', ContainsArrays::class),
