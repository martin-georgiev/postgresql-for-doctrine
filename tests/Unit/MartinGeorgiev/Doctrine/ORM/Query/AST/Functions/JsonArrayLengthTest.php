...
final class JsonArrayLengthTest extends TestCase
{
    ...
    {
        return [
            'gets length of top-level array' => \sprintf('SELECT JSON_ARRAY_LENGTH(e.jsonObject1) FROM %s e', ContainsJsons::class),
