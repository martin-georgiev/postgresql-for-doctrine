...
class RowTest extends BaseVariadicFunctionTestCase
{
    ...
    protected function getExpectedSqlStatements(): array
    {
        return [
            ...
            'SELECT ROW(c0_.jsonbObject1, c0_.jsonbObject2) AS sclr_0 FROM ContainsJsons c0_',
    ...
    protected function getDqlStatements(): array
    {
        return [
            ...
            \sprintf('SELECT ROW(e.jsonbObject1, e.jsonbObject2) FROM %s e', ContainsJsons::class),
